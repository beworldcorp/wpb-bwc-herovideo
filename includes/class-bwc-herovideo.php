...
class BWC_Herovideo_Plugin {
  ...
  public function create_shortcode() {
    ...
    vc_map([
      ...
      'base'        => 'hero_video',
      'description' => __('Vidéo hero + bandeau événements', 'wpb-bwc-herovideo'),
      ...
      'params'      => [
        [
          ...
          'param_name'  => 'id_video',
          'description' => __('ID unique pour le contrôle audio.', 'wpb-bwc-herovideo'),
        ],
        [
          'type'        => 'textfield',
        ...
        [
          ...
          'description' => __('ID unique (facultatif).', 'wpb-bwc-herovideo'),
        ],
        [
          'type'        => 'textfield',
  ...
  public function render_shortcode($atts, $content = null, $tag = '') {
    ...
    $extra_class = sanitize_html_class($atts['extra_class']);
    ...
    // HTML
    $output  = '';
    $output .= '<div class="video-container-desktop ' . $extra_class . '" ' . ($element_id ? 'id="'.esc_attr($element_id).'"' : '') . '>';
    $output .=   '<video id="desktop-' . esc_attr($id_video) . '" playsinline autoplay muted loop src="' . $url_desktop . '"></video>';
    $output .= '</div>';
    ...
    // MOBILE
    $output .= '<div class="video-container-mobile ' . $extra_class . '" ' . ($element_id ? 'id="'.esc_attr($element_id).'"' : '') . '>';
    $output .=   '<video id="mobile-' . esc_attr($id_video) . '" playsinline autoplay muted loop src="' . $url_mobile . '"></video>';
